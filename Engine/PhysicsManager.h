...
public:
	...
	void AddRigidDynamicComponent(std::shared_ptr<RigidDynamicComponent> rigidComponents);
	void RemoveRigidDynamicComponent(std::shared_ptr<RigidDynamicComponent> rigidComponents);
	void AddRigidStaticComponent(std::shared_ptr<RigidStaticComponent> rigidComponents);
	void RemoveRigidStaticComponent(std::shared_ptr<RigidStaticComponent> rigidComponents);
...
private:
	...
	std::list<std::shared_ptr<RigidDynamicComponent>> m_rigidDynamicComponents;
	std::list<std::shared_ptr<RigidStaticComponent>> m_rigidStaticComponents;
